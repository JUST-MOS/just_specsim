...
# local
from .specio import empty_metatable, read_basis_templates
from .log import get_logger, DEBUG
from .cuts import isBGS_colors
from .interpolation import resample_flux
from .pixelsplines import gauss_blur_matrix, cen2bound
...
class EMSpectrum(object):
    ...
    def __init__(self, minwave=3650.0, maxwave=7075.0, cdelt_kms=20.0, log10wave=None,
        ...
        recombfile = 'data/recombination_lines.ecsv'
        forbidfile = 'data/forbidden_lines.ecsv'
        forbidmogfile = 'data/forbidden_mogs.fits'
...
class GALAXY(object):
    ...
    def __init__(self, objtype='ELG', minwave=3600.0, maxwave=10000.0, cdelt=0.2, wave=None,
        ...
        # Pixel boundaries
        #self.pixbound = cen2bound(basewave)
    ...
    def _blurmatrix(self, vdisp, log=None):
        ...
        for uvv in uvdisp:
            ...
            blurmatrix[uvv] = gauss_blur_matrix(self.pixbound, sigma).astype('f4')
...
class BGS(GALAXY):
    ...
    def __init__(self, minwave=3600.0, maxwave=10000.0, cdelt=0.2, wave=None,
        ...
        """
        if colorcuts_function is None:
            colorcuts_function = isBGS_colors
